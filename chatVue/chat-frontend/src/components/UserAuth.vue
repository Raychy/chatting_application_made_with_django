<template>
  <div class="container">
    <h1 class="text-center">Welcome to Chat App</h1>
...
<script>
  ...
  export default {
    ...
    methods: {
      signUp () {
        $.post('http://localhost:8081/auth/users/', this.$data, (data) => {
      ...
      signIn () {
        ...
        $.post('http://localhost:8081/auth/token/login/', credentials, (data) => {
